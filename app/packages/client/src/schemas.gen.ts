...
export const AgentDetailResponseSchema = {
    ...
    type: 'object',
    required: ['agent_id', 'user_id', 'name', 'mode', 'instructions', 'doc_count', 'created_at', 'updated_at'],
...
export const AgentInfoSchema = {
    properties: {
        ...
        doc_count: {
            type: 'integer',
            title: 'Doc Count',
            description: "Number of documents in this agent's RAG index (when from DB)",
            default: 0
        },
        tools: {
            items: {
...
export const ChatRequestSchema = {
    properties: {
        agent_id: {
            ...
            title: 'Agent Id',
            description: 'Agent ID (UUID); when set, backend loads agent and builds system_prompt'
        },
        agent_name: {
            anyOf: [
                {
            ...
            title: 'Agent Name',
            description: 'Agent name (legacy; required when agent_id is not provided)'
        },
        message: {
            type: 'string',
            title: 'Message',
...
export const CreateAgentRequestSchema = {
    ...
    description: 'Request to create an agent (stored in DB). Agent ID is always server-generated.'
} as const;
...
export const HealthResponseSchema = {
    ...
    type: 'object',
    required: ['status', 'agents', 'geminimesh_configured', 'embedding_model', 'database_configured', 'database_connected'],
...
export const UpdateAgentIndexRequestSchema = {
    ...
    description: "Request to add, update, or delete a document in an agent's RAG index."
} as const;
