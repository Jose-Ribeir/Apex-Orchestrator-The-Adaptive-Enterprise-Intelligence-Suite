"""OpenAI LLM provider: router + streaming generator. Alternative to Gemini."""
...
GENERATOR_MODEL_DEFAULT = "gpt-4o"
# Map Gemini-style model names to OpenAI (optional)
MODEL_MAP = {
...
{{"needs_rag": true/false, "tools_needed": ["RAG"] or [], "connections_needed": ["google_gmail"] or [], "model_to_use": "gpt-4o" or "gpt-4o-mini", "reason": "one sentence"}}
"""  # noqa: E501


class OpenAILLMProvider:
    """LLM provider using OpenAI (gpt-4o-mini for router, gpt-4o for generator)."""
    ...
    def optimize_agent_prompt(self, config: AgentConfig) -> tuple[str, dict[str, Any]]:
        """Simple analysis without LLM call; returns (prompt, analysis). For full optimization use Gemini."""
        analysis = {
            "agent_type": "general",
            "complexity": "medium",
